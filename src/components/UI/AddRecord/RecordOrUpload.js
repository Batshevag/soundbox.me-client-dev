...
export default function RecordOrUpload(props) {
  ...
  return (
    <>
      <div className="bigText">Welcome to {userName}’s studio</div>
      <div className="smallText">
        Let’s start create your podcast! put the microphone on,
        <br /> clear your voice and here we go—
        <br />
      </div>
      <div className="d-flex">
        ...
        >
          <label htmlFor="audioUpload">
            <Button className="recordButton">
              ...
              <br />
              <h1 className="textOnButtons">Upload Record</h1>
            </Button>
          </label>
          <input
            type="file"
        ...
        <div className="wrap_recordButton">
          <Button className="recordButton" onClick={props.nextCurrentComponent}>
