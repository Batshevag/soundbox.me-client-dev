...
export default function Recording(props) {
  ...
  return (
    <div>
      ...
      <div>
        <div className="bigText">Recording…</div>
        <div
          className="smallText"
          style={{
            marginBottom: mediaRecorder
        ...
        <div className="d-flex justify-content-center align-items-center">
          ...
          >
            {mediaRecorderState == "inactive" ? (
              ...
              <Button className="recordButton" onClick={pauseRecord}>
      ...
      <div>
        <span className="smallText durationSpan recordingDurationSpan">
          {secondsToHHMMSSFormat(Math.floor(duration))}
        </span>
      </div>
      <div className="d-flex justify-content-center align-items-center RecordingDivButton">
        <button className="RecordingTwiceButton" onClick={handleShow}>
          <h6>New Record</h6>
        </button>
        <button className="RecordingTwiceSaveButton" onClick={stopRecord}>
          <h6>Save</h6>
        </button>
      </div>
      {/* <div>
