...
function SubscribeForm(props) {
  ...
  const validate = (values) => {
    const errors = {};
    if (!values.fullName) {
      if (fieldSubscription.name) errors.fullName = "Name is required";
    }
    if (!values.email) {
    ...
    if (!values.phone) {
      if (fieldSubscription.phone) errors.phone = "Phone is required";
    } else if (!/^$|^\d{10}$/.test(values.phone)) {
      errors.phone = "Invalid phone number";
    }
    if (!values.adress) {
      if (fieldSubscription.adress) errors.adress = "Adress is required";
    }
    return errors;
  };
    ...
    <div className="SubscribeForm SubscribeFormColor">
      <div className="Subwidth d-flex justify-content-center align-item-center ">
        ...
        {!showAlert ? (
            ...
            {({
              ...
              <Form className="Subwidth d-flex justify-content-start ">
                ...
                <Field
                  ...
                  className="SubscribeFormInput"
                  placeholder={
                    touched.phone && errors.phone ? errors.phone : "Phone"
                  }
                  style={{
                    color:
                      errors.phone == "Invalid phone number"
                ...
                <Field
                  ...
                  className="SubscribeFormInput"
                  placeholder={
                    touched.adress && errors.adress ? errors.adress : "Adress"
                  }
                  value={values.adress}
                  onChange={handleChange}
          ...
          <Alert>
            <CheckCircleIcon className="SubscribeFormConfirmIcon" />
