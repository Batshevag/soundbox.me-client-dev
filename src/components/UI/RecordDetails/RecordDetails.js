...
function RecordDetails(props) {
  ...
  useEffect(() => {
    if (
      !Object.keys(props.currentAudio).length &&
      props.currentAudio.constructor === Object
    ) {
  ...
  useEffect(() => {
    if(props.currentAudio.audioUrl==undefined && _id == null){
     history.push(`/admin/${userName}/${channelName}/AddRecord/false`)
    }
    else{
      getAudioById(_id, (audio) => {
            ...
            <div className="currentAudioUploadImgOnHover">
              ...
              <div className="iconDiv">
                ...
                >
                  ...
                  > */}
                  <div onClick={EditUploadImage} className=" wrapIconUploadInHome ">
                    <FontAwesomeIcon
                      id="angle-right"
